...
"""My solution is to split nums into two pieces, the frequencies and the values. Then we use the zip function to
iterate through them both at the same time, create a temporary list that only has <value> <frequency> times, and extend
our result by that list, then return that result."""
...
# After looking
"""Mine seems to be the best type of solution."""
